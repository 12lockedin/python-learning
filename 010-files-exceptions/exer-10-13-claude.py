...
def greet_user():
    ...
    # MORE EFFICIENT, NO REDUNDANT CODE
    # If no stored username or user doesn't verify, get a new username
    if not username or input(f"Hello! Is this your username: {username}? (y/n)\n").lower() != 'y':
